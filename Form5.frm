...
Open "data\f5color.txt" For Input As #1
Line Input #1, bg
Close #1
Dim rtn As Long
Me.BackColor = bg
...
Else
 Label1.Caption = allclass("c2")
End If
End Sub

Private Sub Label1_Click()
If caidan = True Then
 WindowsMediaPlayer1.URL = "themes\cdaudio\2.mp3"
End If
End Sub
...
If Me.Top + 250 >= Form2.Height + Me.Height And speed > 0 Then
 If Me.Top >= Form2.Height + Me.Height + 2000 Then
  Me.Top = Me.Top - speed
 Else
  Me.Top = Me.Top - speed
  speed = speed - 19
