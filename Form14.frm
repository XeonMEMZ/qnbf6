...
Open "data\f14color.txt" For Input As #1
Line Input #1, bg
Close #1
Dim rtn As Long
Me.BackColor = bg
...
If caidan = True Then
 WindowsMediaPlayer1.URL = "themes\cdaudio\11.mp3"
End If
End Sub
...
If Me.Top + 250 >= Form2.Height + Me.Height * 10 And speed > 0 Then
 If Me.Top >= Form2.Height + Me.Height * 10 + 2000 Then
  Me.Top = Me.Top - speed
 Else
  Me.Top = Me.Top - speed
  speed = speed - 18
...
Else
 speed = 1
 Me.Top = Form2.Height + Me.Height * 10
